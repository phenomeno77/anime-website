    ...
    >
      ...
      <div>
        ...
        <p>
          ...
          visitor tracking or analytics services.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          (such as your name, email address, and message) is processed solely
          for the purpose of responding to your inquiry.
        </p>

        <p class="mt-2">
          Your data will not be shared with third parties unless required by
          law.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          To protect this website against spam and abuse, rate limiting is used.
          When a form is submitted, your IP address is processed temporarily to
          detect repeated requests.
        </p>

        <p class="mt-2">
          The IP address is stored only for the duration necessary to enforce
          the rate limit (approximately five minutes) and is then automatically
          discarded.
        </p>
      </div>
      ...
      <div>
        ...
        <p class="mt-3">
          These logs are used solely to ensure the secure and reliable operation
          of the website and are deleted automatically according to the hosting
      ...
      <div>
        ...
        <p>
          No advertising networks, tracking services, or social media plugins
          are integrated into this website.
        </p>
      </div>
